...
import type { CounterQueryDeps } from './counter2-dependency'
import type { CounterQuery, CounterQueryResult } from './types'

export const resolver: QueryResolver<CounterQuery, CounterQueryResult, CounterQueryDeps> = {
...
export const counter2QuerySource = createQuerySource<
  CounterQuery,
  CounterQueryResult,
  CounterQueryDeps
>()
